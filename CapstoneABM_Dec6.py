...
class PatchAgent(Agent):
    ...
    def __init__(self, unique_id, pos, model):
        ...
        # self.density = 0 in case we do not want Housing price as a factor. 
    ...
    def step(self):
        ...
        #self.density = 0 #in case we do not want density as a factor 
        self.density = len(self.model.grid.grid[self.pos[0]][self.pos[1]])-1
...
chart2 = ChartModule([{"Label": "NPoor",
                       "Color": "Red"},
                      {"Label": "NMid",
                      "Color": "Yellow"},
                      {"Label": "NRich",
...
server = ModularServer(BurgessModel,
                       [grid, grid2, grid3, chart, chart2, a],
                       "Burgess Model",
                       userparameters)
